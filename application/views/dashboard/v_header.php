...
<head>
	...
	<title>Website Gallery SMK Al Hafidz | Dashboard</title>
	<link href="<?php echo base_url(); ?>gambar/website/logobulet.png" rel="icon">
	...
	<div class="wrapper">
		...
		<header class="main-header">			
			<a href="<?php echo base_url(); ?>" class="logo">
				<span class="logo-lg"><b>SMK</b>Al Hafidz Leuwiliang</span>
			</a>
					...
					<ul class="nav navbar-nav">
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<img src="<?php echo base_url(); ?>assets/dist/img/avataaars.svg" class="user-image" alt="User Image">
								<span class="hidden-xs">HAK AKSES : <b><?php echo $this->session->userdata('level') ?></b></span>
							</a>
							<ul class="dropdown-menu">
								<li class="user-header">
									<img src="<?php echo base_url(); ?>assets/dist/img/avataaars.svg" class="img-circle" alt="User Image">
									<p>
