...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      ...
      <img src="<?php echo base_url().'/gambar/website/logobulet.png'; ?>" width="30px" class="mr-2">

      <a class="navbar-brand js-scroll" href="#page-top"> SMK Al Hafidz </a>
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="<?php echo base_url('blog'); ?>">Galeri</a>
          </li>
          <li class="nav-item">
